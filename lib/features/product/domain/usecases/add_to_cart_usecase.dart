...
class AddToCartUsecase {
  final AddToCartRepo addTocart;

  AddToCartUsecase({required this.addTocart});

  Future<Either<Failure,AddToCartResponseModel>>call(AddToCartRequestModel addTocartRequest){
    return  addTocart.addTocart(addTocartRequest);
  }
}